...
namespace Aplicacion.Seguridad
{
    public class UsuarioRolAgregar
    {
        ...
        public class Manejador : IRequestHandler<Ejecuta>
        {
            ...
            {
                //Buscame por nombre x medio d lo q trae "request.RolNombre"
                ...
                // ------>>>>  <<<<------//
                //Indicamos cual usuario tendra ese nuevo rol, ese sera usuarioIden y el nombre dl rol 
                ...
                throw new Exception("No se pudo agregar el rol ROL al usuario");
